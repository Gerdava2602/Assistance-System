    ...
    def index(self):
        ...
        if user.is_anonymous:
            ...
            if 'Estudiante' in roles:
                ...
                return render_template("cursos.html", rol='Estudiante',cursos=cur.fetchall(),actual=request.args.get("periodo","Todos") , periodos= periodos,base_template=appbuilder.base_template, appbuilder=appbuilder)
                ...
                return render_template("cursos.html", rol='Docente',cursos=cur.fetchall(), actual=request.args.get("periodo","Todos"),periodos=periodos ,base_template=appbuilder.base_template, appbuilder=appbuilder)
            elif 'Admin' in roles:
